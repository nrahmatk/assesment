...
export default function Messages() {
      ...
      const mockChats: ChatType[] = [
        {
          ...
          lastMessage:
            "Perfect! I'll see you at the hotel lobby tomorrow at 9am.",
          timestamp: "10:42 AM",
          unread: 2,
          isOnline: true,
        },
        {
          ...
          avatar: "/user/1.png",
          lastMessage:
            "Your tour package is confirmed. We'll send you details shortly.",
          timestamp: "Yesterday",
          unread: 0,
          isOnline: true,
        },
        {
          ...
          avatar: "/user/2.png",
          lastMessage:
            "Thank you for your reservation! Your booking ID is BK12345.",
          timestamp: "Mar 25",
          unread: 0,
          isOnline: false,
        },
        {
          ...
          avatar: "/user/3.png",
          lastMessage:
            "Hey! Are you still interested in the island hopping tour?",
          timestamp: "Mar 24",
          unread: 3,
          isOnline: false,
        },
  ...
  const filteredChats = chats.filter((chat) => {
    ...
    const messageMatches = chat.lastMessage
      .toLowerCase()
                  ...
                  <div className="ml-3 flex-1">
                    ...
                    <p
                      className={`text-sm mt-1 ${
                        chat.unread > 0 ? "text-gray-800" : "text-gray-500"
                      } line-clamp-2`}
                    >
                      {chat.lastMessage}
                    </p>
